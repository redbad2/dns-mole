...
void second_method(void *domain_list_one,void *domain_list_two,void *ip,void *mWorld){
    ...
    while(t_domain_1){
        ...
        if(t_domain_1->queried_with_different_ip < 5){
            remove_domain(t_domain_1,0);
        }
        else if(t_domain_2->queried_with_different_ip < 5){
...
void first_method(void *domain,void *ip,void *mWorld){
    ...
    if(t_ip_store){
        ...
        while(t_ip_store){
            ...
            if((float)(t_ip_store->black_hosts/t_ip_store->all_hosts) >=  0.3){
